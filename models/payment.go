...
type Payment struct {
	...
	TicketID  *uint  `json:"ticket_id" gorm:"default:null"`   // Có thể null nếu chưa tạo vé
	EventID   uint   `json:"event_id" gorm:"not null"`        // Sự kiện liên quan
	UserID    uint   `json:"user_id"`         // Người thực hiện thanh toán
	...
	Method    string `json:"method" gorm:"default:'vnpay'"`   // vnpay / momo / ...
	CreatedAt time.Time
	UpdatedAt time.Time
}
